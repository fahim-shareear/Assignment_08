    ...
    return (
        <div className="w-full h-screen flex items-center justify-center">
            <div className="lg:max-w-11/12 flex items-center flex-col mt-20">
                ...
                <button className="p-1 bg-linear-to-br from-purple-600 to bg-purple-500 rounded-md text-[13px] font-bold btn border-none h-7.5 w-20 cursor-pointer" onClick={() => navigate(- 1)}>Go Back!</button>
            </div>
        </div>
    );
};
