    ...
    return (
        <div className="w-full h-[50vh]">
            <div className="lg:max-w-11/12 flex items-center justify-center flex-col">
                ...
                <button className="p-1 bg-linear-to-br from-purple-600 to bg-purple-500 rounded-md text-[13px] font-bold btn border-none h-7.5 w-20" onClick={()=> handlePageState()}>Go Back!</button>
            </div>
        </div>
    );
};
